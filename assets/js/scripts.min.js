    ...
    _createClass(Home, [{
        ...
        value: function initEvents() {
            ...
            this.isMobile || setTimeout(function () {
                ...
                t.addEventListener("mouseover", e.projectsLiMouseOverRef, !1), t.addEventListener("mouseout", e.projectsLiMouseOutRef, !1);
        ...
        value: function stopEvents() {
            var e = this;
            window.removeEventListener("resize", e.resizeRef, !1), e.stagePerspective.removeEventListener("scroll", e.scrollRef, !1), e.projectsLi.forEach(function (t) {
                //t.removeEventListener("click", e.projectsLiClickRef, !1),
                t.removeEventListener("mouseover", e.projectsLiMouseOverRef, !1), t.removeEventListener("mouseout", e.projectsLiMouseOutRef, !1);
            });
        ...
        value: function initHome() {
            ...
            this.isMobile || (this.resize(), this.loop()), setTimeout(function () {
        ...
        key: 'projectsLiClick',
        value: function projectsLiClick(event) {
        ...
        value: function projectsLiMouseOver(event) {
        ...
        value: function projectsLiMouseOut(event) {
        ...
        value: function projectsLiAClick(e) {
...
window.addEventListener("load", function (e) {
    ...
    }), navAbout.forEach(function (nav) {

        nav.addEventListener("click", function (t) {
            t.stopPropagation(), t.preventDefault(), isMobile && documentBody.classList.remove("mobileNavOpen"), aboutContainer.scrollTop = 0, documentBody.classList.add("navTop"), documentBody.classList.add("aboutShow"), about.forEach(function (el) {
                el.classList.remove("isActive");
            });
            navAbout.forEach(function (el) {
                el.classList.remove("isActive");
            });
    ...
    var FadeOutTransition = Barba.BaseTransition.extend({
        ...
        outro: function (_outro) {
            function outro() {
                return _outro.apply(this, arguments);
            }

            outro.toString = function () {
                return _outro.toString();
            };
    ...
    var Homepage = Barba.BaseView.extend({
        ...
        onEnterCompleted: function onEnterCompleted() {
            ...
            documentBody.classList.add("home-page-js"), initPage(), setTimeout(function () {
